 ...
 * 
 * Note: This file uses browser APIs (document, canvas) and should only be used
 * in client-side code or server-side code that runs in a browser-like environment.
 */
